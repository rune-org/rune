...
def publish_split_agg_execution(channel, execution_id, workflow_id):
    execution_event = {
        ...
        "workflow_definition": build_split_agg_workflow_definition(workflow_id, execution_id),
...
def publish_split_item_status(channel, execution_id, workflow_id, item_index, total_items):
...
def publish_aggregator_status(channel, execution_id, workflow_id, processed_count, total_items, state, final=False):
    status_event = {
        "workflow_id": workflow_id,
        "execution_id": execution_id,
        "node_id": AGG_NODE_ID,
...
if __name__ == "__main__":
    try:
        ...
        for i in range(total_items):
            publish_split_item_status(channel, split_execution_id, split_workflow_id, i, total_items)

        # Final aggregator success
        publish_aggregator_status(channel, split_execution_id, split_workflow_id, total_items, total_items, state="completed", final=True)
