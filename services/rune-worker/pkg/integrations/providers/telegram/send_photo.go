...
func (SendPhoto) Kind() string {
	return SendPhotoKind
}

func (SendPhoto) Execute(ctx context.Context, ec plugin.ExecutionContext) (map[string]any, error) {
	var args sendPhotoArgs
	...
	if args.Photo == "" {
		return nil, errors.New("argument 'photo' is required")
	}
...
func init() {
	integrations.Register(SendPhoto{})
}
