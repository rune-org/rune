 ...
 */
export const spMetadataAuthSamlMetadataGet = <ThrowOnError extends boolean = false>(options?: Options<SpMetadataAuthSamlMetadataGetData, ThrowOnError>) => (options?.client ?? client).get<SpMetadataAuthSamlMetadataGetResponses, unknown, ThrowOnError>({ url: '/auth/saml/metadata', ...options });
 ...
 */
export const samlLoginAuthSamlLoginGet = <ThrowOnError extends boolean = false>(options?: Options<SamlLoginAuthSamlLoginGetData, ThrowOnError>) => (options?.client ?? client).get<unknown, SamlLoginAuthSamlLoginGetErrors, ThrowOnError>({ url: '/auth/saml/login', ...options });
 ...
 */
export const discoverAuthSamlDiscoverGet = <ThrowOnError extends boolean = false>(options: Options<DiscoverAuthSamlDiscoverGetData, ThrowOnError>) => (options.client ?? client).get<DiscoverAuthSamlDiscoverGetResponses, DiscoverAuthSamlDiscoverGetErrors, ThrowOnError>({ url: '/auth/saml/discover', ...options });
 ...
 */
export const assertionConsumerServiceAuthSamlAcsPost = <ThrowOnError extends boolean = false>(options: Options<AssertionConsumerServiceAuthSamlAcsPostData, ThrowOnError>) => (options.client ?? client).post<unknown, AssertionConsumerServiceAuthSamlAcsPostErrors, ThrowOnError>({
 ...
 */
export const singleLogoutAuthSamlSloGet = <ThrowOnError extends boolean = false>(options?: Options<SingleLogoutAuthSamlSloGetData, ThrowOnError>) => (options?.client ?? client).get<unknown, SingleLogoutAuthSamlSloGetErrors, ThrowOnError>({ url: '/auth/saml/slo', ...options });
 ...
 */
export const exchangeSsoCodeAuthSamlExchangePost = <ThrowOnError extends boolean = false>(options: Options<ExchangeSsoCodeAuthSamlExchangePostData, ThrowOnError>) => (options.client ?? client).post<ExchangeSsoCodeAuthSamlExchangePostResponses, ExchangeSsoCodeAuthSamlExchangePostErrors, ThrowOnError>({
 ...
 */
export const deleteSamlConfigAuthSamlConfigDelete = <ThrowOnError extends boolean = false>(options?: Options<DeleteSamlConfigAuthSamlConfigDeleteData, ThrowOnError>) => (options?.client ?? client).delete<DeleteSamlConfigAuthSamlConfigDeleteResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getSamlConfigAuthSamlConfigGet = <ThrowOnError extends boolean = false>(options?: Options<GetSamlConfigAuthSamlConfigGetData, ThrowOnError>) => (options?.client ?? client).get<GetSamlConfigAuthSamlConfigGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/auth/saml/config',
    ...options
});
 ...
 */
export const createSamlConfigAuthSamlConfigPost = <ThrowOnError extends boolean = false>(options: Options<CreateSamlConfigAuthSamlConfigPostData, ThrowOnError>) => (options.client ?? client).post<CreateSamlConfigAuthSamlConfigPostResponses, CreateSamlConfigAuthSamlConfigPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/auth/saml/config',
    ...options,
    headers: {
 ...
 */
export const updateSamlConfigAuthSamlConfigPut = <ThrowOnError extends boolean = false>(options: Options<UpdateSamlConfigAuthSamlConfigPutData, ThrowOnError>) => (options.client ?? client).put<UpdateSamlConfigAuthSamlConfigPutResponses, UpdateSamlConfigAuthSamlConfigPutErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/auth/saml/config',
    ...options,
    headers: {
 ...
 */
export const checkSetupStatusSetupStatusGet = <ThrowOnError extends boolean = false>(options?: Options<CheckSetupStatusSetupStatusGetData, ThrowOnError>) => (options?.client ?? client).get<CheckSetupStatusSetupStatusGetResponses, unknown, ThrowOnError>({ url: '/setup/status', ...options });
 ...
 */
export const initializeFirstAdminSetupInitializePost = <ThrowOnError extends boolean = false>(options: Options<InitializeFirstAdminSetupInitializePostData, ThrowOnError>) => (options.client ?? client).post<InitializeFirstAdminSetupInitializePostResponses, InitializeFirstAdminSetupInitializePostErrors, ThrowOnError>({
 ...
 * List Workflows
 */
export const listWorkflowsWorkflowsGet = <ThrowOnError extends boolean = false>(options?: Options<ListWorkflowsWorkflowsGetData, ThrowOnError>) => (options?.client ?? client).get<ListWorkflowsWorkflowsGetResponses, ListWorkflowsWorkflowsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/workflows/',
    ...options
});
 ...
 */
export const bulkWorkflowOperationWorkflowsBulkPost = <ThrowOnError extends boolean = false>(options: Options<BulkWorkflowOperationWorkflowsBulkPostData, ThrowOnError>) => (options.client ?? client).post<BulkWorkflowOperationWorkflowsBulkPostResponses, BulkWorkflowOperationWorkflowsBulkPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/workflows/bulk',
    ...options,
    headers: {
 ...
 */
export const listWorkflowVersionsWorkflowsWorkflowIdVersionsGet = <ThrowOnError extends boolean = false>(options: Options<ListWorkflowVersionsWorkflowsWorkflowIdVersionsGetData, ThrowOnError>) => (options.client ?? client).get<ListWorkflowVersionsWorkflowsWorkflowIdVersionsGetResponses, ListWorkflowVersionsWorkflowsWorkflowIdVersionsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const createWorkflowVersionWorkflowsWorkflowIdVersionsPost = <ThrowOnError extends boolean = false>(options: Options<CreateWorkflowVersionWorkflowsWorkflowIdVersionsPostData, ThrowOnError>) => (options.client ?? client).post<CreateWorkflowVersionWorkflowsWorkflowIdVersionsPostResponses, CreateWorkflowVersionWorkflowsWorkflowIdVersionsPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/workflows/{workflow_id}/versions',
    ...options,
    headers: {
 ...
 */
export const publishWorkflowVersionWorkflowsWorkflowIdPublishPost = <ThrowOnError extends boolean = false>(options: Options<PublishWorkflowVersionWorkflowsWorkflowIdPublishPostData, ThrowOnError>) => (options.client ?? client).post<PublishWorkflowVersionWorkflowsWorkflowIdPublishPostResponses, PublishWorkflowVersionWorkflowsWorkflowIdPublishPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const restoreWorkflowVersionWorkflowsWorkflowIdRestoreVersionIdPost = <ThrowOnError extends boolean = false>(options: Options<RestoreWorkflowVersionWorkflowsWorkflowIdRestoreVersionIdPostData, ThrowOnError>) => (options.client ?? client).post<RestoreWorkflowVersionWorkflowsWorkflowIdRestoreVersionIdPostResponses, RestoreWorkflowVersionWorkflowsWorkflowIdRestoreVersionIdPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listUserExecutionsExecutionsGet = <ThrowOnError extends boolean = false>(options?: Options<ListUserExecutionsExecutionsGetData, ThrowOnError>) => (options?.client ?? client).get<ListUserExecutionsExecutionsGetResponses, ListUserExecutionsExecutionsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/executions/',
    ...options
});
 ...
 * **Requires:** VIEW permission (OWNER, EDITOR, or VIEWER)
 */
export const getWorkflowExecutionsExecutionsWorkflowsWorkflowIdGet = <ThrowOnError extends boolean = false>(options: Options<GetWorkflowExecutionsExecutionsWorkflowsWorkflowIdGetData, ThrowOnError>) => (options.client ?? client).get<GetWorkflowExecutionsExecutionsWorkflowsWorkflowIdGetResponses, GetWorkflowExecutionsExecutionsWorkflowsWorkflowIdGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listUsersForSharingUsersDirectoryGet = <ThrowOnError extends boolean = false>(options?: Options<ListUsersForSharingUsersDirectoryGetData, ThrowOnError>) => (options?.client ?? client).get<ListUsersForSharingUsersDirectoryGetResponses, ListUsersForSharingUsersDirectoryGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/users/directory',
    ...options
});
 ...
 */
export const setUserStatusUsersUserIdStatusPatch = <ThrowOnError extends boolean = false>(options: Options<SetUserStatusUsersUserIdStatusPatchData, ThrowOnError>) => (options.client ?? client).patch<SetUserStatusUsersUserIdStatusPatchResponses, SetUserStatusUsersUserIdStatusPatchErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listCredentialsCredentialsGet = <ThrowOnError extends boolean = false>(options?: Options<ListCredentialsCredentialsGetData, ThrowOnError>) => (options?.client ?? client).get<ListCredentialsCredentialsGetResponses, ListCredentialsCredentialsGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/credentials/',
    ...options
});
 ...
 */
export const generateWorkflowDocsScrybWorkflowIdPost = <ThrowOnError extends boolean = false>(options: Options<GenerateWorkflowDocsScrybWorkflowIdPostData, ThrowOnError>) => (options.client ?? client).post<GenerateWorkflowDocsScrybWorkflowIdPostResponses, GenerateWorkflowDocsScrybWorkflowIdPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
