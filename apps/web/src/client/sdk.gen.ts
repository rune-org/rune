 ...
 * **Requires:** EDIT permission (OWNER or EDITOR)
 */
export const toggleScheduleWorkflowsWorkflowIdScheduleTogglePatch = <ThrowOnError extends boolean = false>(options: Options<ToggleScheduleWorkflowsWorkflowIdScheduleTogglePatchData, ThrowOnError>) => (options.client ?? client).patch<ToggleScheduleWorkflowsWorkflowIdScheduleTogglePatchResponses, ToggleScheduleWorkflowsWorkflowIdScheduleTogglePatchErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
