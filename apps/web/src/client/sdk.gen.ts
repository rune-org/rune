 ...
 * **Requires:** EDIT permission (OWNER or EDITOR)
 */
export const updateDescriptionWorkflowsWorkflowIdDescriptionPut = <ThrowOnError extends boolean = false>(options: Options<UpdateDescriptionWorkflowsWorkflowIdDescriptionPutData, ThrowOnError>) => (options.client ?? client).put<UpdateDescriptionWorkflowsWorkflowIdDescriptionPutResponses, UpdateDescriptionWorkflowsWorkflowIdDescriptionPutErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const listUserExecutionsExecutionsGet = <ThrowOnError extends boolean = false>(options?: Options<ListUserExecutionsExecutionsGetData, ThrowOnError>) => (options?.client ?? client).get<ListUserExecutionsExecutionsGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/executions/',
    ...options
});
 ...
 */
export const listUsersForSharingUsersDirectoryGet = <ThrowOnError extends boolean = false>(options?: Options<ListUsersForSharingUsersDirectoryGetData, ThrowOnError>) => (options?.client ?? client).get<ListUsersForSharingUsersDirectoryGetResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/users/directory',
    ...options
});
