...
export interface Credential {
  ...
  values: Record<string, any> | undefined;  // Type-specific credential values (actual secrets)
}
...
export interface ScheduledtriggerParameters {
  ...
  amount: number | undefined;  // Quantity of time between executions
  unit: "seconds" | "minutes" | "hours" | "days" | undefined;  // Unit of time for the interval
}
