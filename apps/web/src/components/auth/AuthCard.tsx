  ...
  return (
    <div className="relative w-full max-w-md mx-auto">
      ...
      <motion.div
        ...
        className={cn(
          "relative overflow-hidden rounded-3xl border border-border bg-card/40 backdrop-blur-xl shadow-2xl",
          className,
        )}
      >
        ...
        <div className="relative z-10 p-8 md:p-10 flex flex-col gap-6">
          <div className="space-y-2 text-center">
            <h1
              className="text-3xl font-bold font-serif tracking-tight text-foreground"
          ...
          {footer && <div className="text-center text-sm text-muted-foreground pt-2">{footer}</div>}
        </div>
      </motion.div>
    </div>
  );
