  ...
  return (
    ...
    >
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        <div
          className="absolute w-[500px] h-[500px] bg-primary/10 blur-[120px] rounded-full opacity-50 mix-blend-screen animate-pulse"
      ...
      <Container className="relative z-10">
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          >
            Make automation simple, accessible, and powerful{" "}
            <span className="text-muted-foreground/60 font-semibold italic">
              <br />
              for everyone.
            </span>
          </motion.h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-24 text-left md:px-8 pt-12 border-t border-white/5">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Rune empowers product teams, operations, and developers to
                launch reliable workflows without piecing together brittle
                scripts. We believe the tools you use should feel like
                superpowers, not chores.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We build for teams juggling rapid iteration and enterprise
                scale, pairing an intuitive canvas with battle-tested
                infrastructure. It&apos;s automation designed for the way you
                actually work.
              </p>
            </motion.div>
          </div>
