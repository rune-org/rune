...
export function Hero() {
  return (
    <section
      className={cn(
        "relative w-full min-h-screen flex flex-col justify-center items-center overflow-hidden pt-32 pb-20",
        playfair.variable,
      )}
    >
      ...
      <div className="container relative z-10 flex flex-col items-center text-center space-y-10 mx-auto px-4">
        ...
        <div className="space-y-6 max-w-5xl">
          ...
          >
            The infinite canvas for everyone. Orchestrate data, APIs, and agents with a simple drag
            and drop!
          </motion.p>
        </div>
