...
export function Hero() {
  return (
    <Section>
      ...
      <div className="overflow-hidden rounded-[var(--radius)] border border-border/60 bg-gradient-to-br from-primary/20 via-background to-secondary/40 p-8 shadow-[0_40px_80px_hsl(220_55%_6%/0.35)]">
