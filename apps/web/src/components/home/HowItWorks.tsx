...
const steps = [
  {
    ...
    description:
      "Drag triggers and actions from the library. Supports Webhooks, HTTP, Postgres, Slack, and more.",
  },
  {
    id: "02",
    title: "Add logic & AI",
    description:
      "Use 'If' nodes to route data, or drop in an 'Agent' node to make decisions using LLMs.",
  },
  {
    id: "03",
    title: "Deploy to Edge",
    description:
      "One click deploy. We compile your graph to a high-performance worker running on the edge.",
  },
];
      ...
      <Container className="flex flex-col gap-16 md:gap-24">
        <div className="space-y-16">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            >
              Visual clarity, <br />
              <span className="text-muted-foreground italic font-normal text-4xl">
                Uncompromised power.
              </span>
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed">
              Stop wrestling with cron jobs. Rune is the modern standard for
              orchestration.
            </p>
          </div>
