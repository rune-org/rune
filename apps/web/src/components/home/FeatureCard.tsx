  ...
  return (
    ...
    >
      <div className="relative z-20 p-8 flex flex-col">
        ...
        <p className="text-muted-foreground leading-relaxed text-sm max-w-[90%]">
          {description}
        </p>
      </div>
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      <div className="relative w-full max-w-[85%] h-full flex items-center justify-center">
        ...
        <div
          className="absolute z-20 w-full bg-zinc-900/80 border border-white/10 rounded-xl p-4 shadow-xl backdrop-blur-sm transition-all duration-500 ease-out
        ...
        <div
          className="absolute z-10 w-full bg-zinc-900/60 border border-white/10 rounded-xl p-4 shadow-lg backdrop-blur-sm transition-all duration-500 ease-out
